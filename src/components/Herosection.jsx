    ...
    <section>
        <div className="flex flex-col items-center md:flex-row gap-20 px-15 mt-20">
            ...
            <div className="w-full md:w-1/2">
                ...
                <h3 className="sub-heading flex">I'm a <span className="text-blue-500 ml-2">web developer</span></h3>
    ...
    return (
        <>
            <div className='flex justify-center text-center mt-20'>
                <p className='text-secondary w-2xl text-sm'>Lorem ipsum dolor sit amet consectetur adipisicing elit.</p>
            </div>
